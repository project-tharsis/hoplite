    ...
    def run(self) -> dict:
        ...
        return {
            ...
            "summary": {
                ...
                "wk_too_harsh": status_counts["wk_too_harsh"],
                "wk_too_generous": status_counts["wk_too_generous"],
                "dimension_level_disagreement": status_counts["dimension_level_disagreement"],
                "model_level_disagreement": status_counts["model_level_disagreement"],
            },
