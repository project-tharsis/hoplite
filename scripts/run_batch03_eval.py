#!/usr/bin/env python3
"""Run evaluator B on batch 3 of b-003 jobs."""
...
def main():
    base = Path("/home/shuohw/hoplite/data/self_iteration/runs/b-003")
    jobs_path = base / "batch_03_jobs.jsonl"
    output_path = base / "batch_03_results.jsonl"
